...
#define ACHIEVEMENT_FIREFIGHTRELOADED_GRAPPLEKICK					189
#define ACHIEVEMENT_FIREFIGHTRELOADED_MULTIKILLSTREAK				190
#define ACHIEVEMENT_FIREFIGHTRELOADED_SKYBORNDECAPKICK				191
//END FR ACHIEVEMENTS
