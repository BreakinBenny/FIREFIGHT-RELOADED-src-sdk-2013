...
//===========================
	...
	ADD_ACTIVITY_TO_SR(ACT_FR_DUALWIELD_IDLE);
	ADD_ACTIVITY_TO_SR(ACT_FR_DUALWIELD_RUN);
	ADD_ACTIVITY_TO_SR(ACT_FR_DUALWIELD_CROUCH_WALK);
	ADD_ACTIVITY_TO_SR(ACT_FR_DUALWIELD_CROUCH_IDLE);
	ADD_ACTIVITY_TO_SR(ACT_FR_DUALWIELD_GESTURE_RANGE_ATTACK_L);
	ADD_ACTIVITY_TO_SR(ACT_FR_DUALWIELD_GESTURE_RANGE_ATTACK_R);
	ADD_ACTIVITY_TO_SR(ACT_FR_DUALWIELD_JUMP);
	ADD_ACTIVITY_TO_SR(ACT_FR_DUALWIELD_GESTURE_RELOAD);
