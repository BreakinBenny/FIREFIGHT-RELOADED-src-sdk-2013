...
BEGIN_RECV_TABLE_NOBASE(C_BaseEntity, DT_BaseEntity)
	...
	RecvPropBool(RECVINFO(m_bBoss)),
	RecvPropBool(RECVINFO(m_isRareEntity)),
...
//	DEFINE_PRED_FIELD( m_flSimulationTime, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),
	...
	DEFINE_PRED_FIELD(m_bBoss, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE),
	DEFINE_PRED_FIELD(m_isRareEntity, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE),
