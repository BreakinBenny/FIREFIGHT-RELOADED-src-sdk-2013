...
void Path::DrawInterpolated( float from, float to )
{
	...
	do
	{
		...
		MoveCursor( t );
		const Data &cursordata = GetCursorData();
		
		float curvePower = 3.0f * cursordata.curvature;
		...
		NDebugOverlay::Line( lastPos, cursordata.pos, r, g, 0, true, 0.1f );
