...
EDIT from Bitl: As of 4/14/2025, I updated the Steamworks headers with the updated ones from the new MP Source SDK which runs v1.57 (https://github.com/ValveSoftware/source-sdk-2013/tree/master/src/public/steam). The above warning still applies when updating the SDK to a version other than v1.26a or v1.57.
